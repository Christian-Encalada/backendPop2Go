...
export class UsersController {
  ...
  findAll(@Req() req) {
    return this.usersService.findAll(req.user.cityId, req.user.roles);
  }
  ...
  findOne(@Param("id", ParseIntPipe) id: number, @Req() req) {
    return this.usersService.findOne(id, req.user.cityId, req.user.roles);
  }
  ...
  remove(@Param("id", ParseIntPipe) id: number, @Req() req) {
    return this.usersService.remove(id, req.user.cityId, req.user.roles);
  }
}
